...
A random forest was explored as an alternative tree-based method. A random forest is an ensemble of decision trees, in which each tree is trained on a subsample of the data and input features, and the output is the mean of the outputs from every tree \citep{james_introduction_2023}.
