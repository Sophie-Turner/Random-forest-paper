...
\title{Emulation of the United Kingdom Chemistry and Aerosols (version 13.9) Photolysis Schemes (Fast-JX version 6.4) with a Random Forest (Forest-J version 1.0)}
...
% Accuracy.
The random forest was able to emulate UKCA photolysis rate coefficients accurately, with a coefficient of determination of 0.97 compared to the original scheme over all emulated reactions, and 0.76 to over 0.99 for individual reactions. When coupled to the UM, the results compared well between simulations with the standard photolysis scheme and the emulator. Ozone mixing ratios were... {summarise the impacts on concentrations of species} 
% Speedup.
...
Fast-JX performs several linear functions to determine flux, $F$, at every latitude, longitude and vertical level, for each wavelength bin.
...
\begin{figure}[htpb]
    \centering 
    \includegraphics[scale=0.9]{images/Forest n trees MSE.png}
...
\begin{figure}[htpb]
    \centering 
    \includegraphics[scale=0.95]{images/n trees R2.png}
